...
public class PruebaRestauranteJhApp {

    private static final Logger log = LoggerFactory.getLogger(PruebaRestauranteJhApp.class);

    private final Environment env;

    public PruebaRestauranteJhApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes PruebaRestauranteJH.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PruebaRestauranteJhApp.class);
